    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <Text className="text-lg" h1 size={50} weight="bold">
        ...
        <div style={{ display: "flex", justifyContent: "center", }}>
            <iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/ctBfzd?gui=true&t=10&paused=true&muted=false" allowfullscreen></iframe>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", }}>
            <iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/mdtcWn?gui=true&t=10&paused=true&muted=false" allowfullscreen></iframe>
        </div>
          <h2 className="mx-auto mt-8 mb-8 max-w-l text-lg sm:text-gray-400  text-gray-500 leading-7">
        ...
        <div style={{ display: "flex", justifyContent: "center", }}>
            <iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/msdyDn?gui=true&t=10&paused=true&muted=false" allowfullscreen></iframe>
        </div>
        <h2 className="mx-auto mt-8 mb-8 max-w-l text-lg sm:text-gray-400  text-gray-500 leading-7">
        ...
        <div style={{ display: "flex", justifyContent: "center", }}>
            <iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/mddcW4?gui=true&t=10&paused=true&muted=false" allowfullscreen></iframe>
        </div>
      </main>
      <Footer />
    </div>
